...
export const metadata: Metadata = {
  title: 'About Us | RealtyFlow',
  description: 'Learn about the team, mission, and vision behind RealtyFlow.',
};
  ...
  return (
    <main id="main-content" className="flex flex-col min-h-screen">
      ...
      <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-96 h-96 bg-white/10 rounded-full blur-[100px] pointer-events-none -translate-x-1/2 -translate-y-1/2"></div>
        
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center max-w-3xl">
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6">Be part of the revolution</h2>
          <p className="text-primary-foreground/80 text-lg mb-10 max-w-xl mx-auto">
            We are always looking for driven agencies and talented individuals to join our journey.
          </p>
