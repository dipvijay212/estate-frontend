...
import { FeaturesContent } from '@/features/features/components/FeaturesContent';
import { Button } from '@/components/ui/button';
import { ArrowRight } from 'lucide-react';
import Link from 'next/link';

export const metadata: Metadata = {
  title: 'Features | RealtyFlow',
  description: 'Explore the powerful modules that make RealtyFlow the ultimate real estate operating system.',
};
  ...
  return (
    <main id="main-content" className="flex flex-col min-h-screen">
      ...
      <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-[100px] pointer-events-none translate-x-1/4 -translate-y-1/4"></div>
        
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center max-w-3xl">
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6">Ready to see it in action?</h2>
          <p className="text-primary-foreground/80 text-lg mb-10 max-w-xl mx-auto">
            Experience the full power of RealtyFlow. Start your free 14-day trial today, no credit card required.
          </p>
